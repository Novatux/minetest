...
s16 BiomeDefManager::calcBlockHeat(v3POS p, u64 seed, float timeofday, float totaltime) {
...
s16 BiomeDefManager::calcBlockHumidity(v3POS p, u64 seed, float timeofday, float totaltime) {
